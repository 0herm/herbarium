...
import NavBar from '@parent/frontend/src/components/nav/nav'
import Footer from '@parent/frontend/src/components/footer/footer'
import { Toaster } from '@parent/frontend/src/components/ui/sonner'
