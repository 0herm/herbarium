...
import Input from '@parent/frontend/src/components/inputs/input'
import Checkbox from '@parent/frontend/src/components/inputs/checkbox'
import Slider from '@parent/frontend/src/components/inputs/slider'
